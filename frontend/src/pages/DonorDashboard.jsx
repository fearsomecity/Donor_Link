      ...
      <div className="relative max-w-6xl mx-auto z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          <div className="glass p-10 rounded-[2.5rem]">
            <h2 className="text-2xl font-bold text-neutral-900 mb-6 font-header">AI Health Assistant</h2>
          ...
          <div className="glass p-10 rounded-[2.5rem] flex flex-col">
            <h2 className="text-2xl font-bold text-neutral-900 mb-6 font-header">Upcoming Appointments</h2>
            <div className="space-y-4 flex-1">
              {loading ? (
                ...
                <div className="p-8 border-2 border-dashed border-neutral-100 rounded-3xl text-center flex flex-col items-center gap-4">
...
function AppointmentItem({ hospital, date, time }) {
  return (
    <div className="flex items-center justify-between p-6 bg-white rounded-2xl border border-neutral-100 shadow-sm hover:border-crimson-100 transition-colors group">
      <div>
        <h4 className="font-bold text-neutral-900">{hospital}</h4>
